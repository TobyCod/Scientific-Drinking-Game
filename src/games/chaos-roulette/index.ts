...
export const CARDS: CardDef[] = [
  ...
  { text: 'Alle zeigen gleichzeitig auf die Person, die am häufigsten zu spät kommt. Die Runde trinkt auf sie.', target: 'all', kicker: 'Abstimmung', minPlayers: 3, heat: 1 },
  ...
  { text: 'Zeig auf die Person, die den besten Musikgeschmack hat. Die Runde prostet ihr zu – alle trinken.', target: 'all', kicker: 'Abstimmung', minPlayers: 3, heat: 2 },
  ...
  { text: 'Zeig auf die Person, die am schnellsten betrunken wird. Die Runde trinkt ihr zu.', target: 'all', kicker: 'Abstimmung', minPlayers: 3, heat: 3 },
  ...
  { text: 'Wer schon mal jemanden aus dieser Runde attraktiv fand, hebt die Hand – Namen bleiben geheim. Danach trinkt die ganze Runde.', target: 'all', kicker: 'Gruppe', minPlayers: 3, heat: 3, spicy: true },
  ...
  { text: 'Zeigt gleichzeitig auf die Person mit dem besten Flirtblick. Die Runde trinkt auf sie.', target: 'all', kicker: 'Abstimmung', minPlayers: 3, heat: 3, spicy: true },
